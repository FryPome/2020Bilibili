...
if py3k:
    ...
    _zh2Hant, _zh2Hans = {}, {}
    for old, new in ((zh_wiki.zh2Hant, _zh_wiki.zh2Hant), (zh_wiki.zh2Hans, _zh_wiki.zh2Hans)):
        for k, v in old.items():
            new[k.decode('utf8')] = v.decode('utf8')
    zh_wiki.zh2Hant = _zh_wiki.zh2Hant
    zh_wiki.zh2Hans = _zh_wiki.zh2Hans
    UEMPTY = ''.decode('utf8')
...
registery('zh-hant', zh_wiki.zh2Hant)
registery('zh-hans', zh_wiki.zh2Hans)
del zh_wiki.zh2Hant, zh_wiki.zh2Hans
